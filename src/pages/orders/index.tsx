...
function OrderListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrderInterface[]>(
    ...
    () =>
      getOrders({
        relations: ['user', 'organization', 'voice_note.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('voice_note', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>voice_note</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('voice_note', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.voice_note}</Td>
                    )}
                    <Td>
